...
const allNavItems = [
  ...
  { to: "/kitchen-store",     icon: UtensilsCrossed,  label: "Kitchen Store",    modules: ["admin","manager","kitchen","hod"] },
  { to: "/bar-store",         icon: Wine,             label: "Bar Store",        modules: ["admin","manager","kitchen","hod"] },
  ...
  { to: "/consumption",       icon: FlaskConical,     label: "Consumption",      modules: ["admin","manager","kitchen","hod"] },
  { to: "/daily-inventory",   icon: ClipboardList,    label: "Daily Inventory",  modules: ["admin","manager"] },
